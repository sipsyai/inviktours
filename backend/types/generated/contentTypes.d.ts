...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings including navigation, logo, and site information';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    footerText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9 2025 Inviktours. T\u00FCm haklar\u0131 sakl\u0131d\u0131r.'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
    ...
    navigationLinks: Schema.Attribute.Component<'layout.navigation-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    siteDescription: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Do\u011Fan\u0131n kalbine unutulmaz bir yolculuk'>;
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Inviktours'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Tour listings with dynamic content sections';
    displayName: 'Tour';
    pluralName: 'tours';
    singularName: 'tour';
  };
